				 ...
				 <li class="nav-item">
					 ...
					 <li class="nav-item">
						<a href="add_testimonial.php" class="group">
							<div class="flex items-center">
								<i class="fa-solid fa-pen-to-square"></i>
								<span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Add Testimonial</span>
							</div>
						</a>
					</li>
					<li class="nav-item">
						<a href="add_testimonial.php" class="group">
							<div class="flex items-center">
								<i class="fa-solid fa-pen-to-square"></i>
								<span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Add Testimonial List</span>
							</div>
						</a>
					</li>
				</ul>

					...
					<div class="logo-cat-wrap">
						<div class="logo-part">
							...
							<!--<img class="normal-logo" src="assets/images/lite-logo.png" alt=""> -->
								<img class="normal-logo" src="assets/images/dark-logo.png" alt="">
							</a>
						</div>
					</div>
				</div>
				<div class="col-lg-8 text-right">
				  <div class="rs-menu-area">
					  <div class="main-menu">
						  ...
						  <nav class="rs-menu">
							 <ul class="nav-menu">
								<li class="rs-mega-menu mega-rs current-menu-item"> <a href="index.php">Home</a>
								</li>
										...
										<ul class="cart-icon-product-list">
											<li class="display-flex">
												...
												<div class="product-info">
													<a href="cart.php">Law Book</a><br>
													<span class="quantity">1 × $30.00</span>
												</div>
												<div class="product-image">
													<a href="cart.php"><img src="assets/images/shop/1.jpg" alt="Product Image"></a>
												</div>
											</li>
											<li class="display-flex">
												<div class="icon-cart">
												...
												<div class="product-info">
													<a href="cart.php">Spirit Level</a><br>
													<span class="quantity">1 × $30.00</span>
												</div>
												<div class="product-image">
													<a href="cart.php"><img src="assets/images/shop/2.jpg" alt="Product Image"></a>
												</div>
											</li>
										</ul>
